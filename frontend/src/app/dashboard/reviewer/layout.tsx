  ...
  const sidebarNav = [
    {
      ...
      items: [
        { label: 'Chiến dịch của tôi', href: '/dashboard/reviewer', count: 0 },
        { label: 'Chiến dịch yêu thích', href: '#', count: 0 },
        { label: 'Review của tôi', href: '#', count: 0 },
        { label: 'Gửi tin nhắn', href: '#', count: 0 },
      ]
    },
    {
      title: 'Tài khoản',
      items: [
        { label: 'Thông tin', href: '/dashboard/reviewer/profile' },
        { label: 'Mạng xã hội', href: '#' },
        { label: 'Điểm của tôi', href: '#', count: 0 },
      ]
    },
    {
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col md:flex-row items-center gap-8 mb-8">
          <div className="flex items-center gap-6 flex-1">
            ...
            <div>
              ...
              <div className="text-xl font-bold text-gray-900 mb-4">{user?.profile?.fullName || user?.profile?.username || 'Reviewer'}</div>
              <div className="flex gap-8 text-sm">
                 <div>
                    <div className="text-gray-500 mb-1">Điểm</div>
                    <div className="font-bold text-gray-900">0 P</div>
                 </div>
                 <div>
                    <div className="text-gray-500 mb-1">Review của tôi</div>
                    <div className="font-bold text-gray-900">0</div>
                 </div>
                 <div>
                    <div className="text-gray-500 mb-1">Thông báo</div>
                    <div className="font-bold text-gray-900">0</div>
                 </div>
              </div>
            </div>
